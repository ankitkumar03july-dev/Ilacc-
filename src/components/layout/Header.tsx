...
import { Menu, X, Search, Facebook, Youtube, Instagram, Linkedin } from "lucide-react";
        ...
        <div className="flex items-center justify-between py-2 md:py-3">
          ...
          <div className="hidden lg:flex items-center gap-6">
            ...
            <nav className="flex items-center gap-1">
              ...
              <button className="px-3 py-2 hover:text-primary rounded transition-colors" aria-label="Search">
            ...
            {/* CTA Buttons */}
            <div className="flex items-center gap-2">
              <Button variant="outline" size="sm" className="text-xs px-4 border-primary text-primary hover:bg-primary hover:text-primary-foreground">
                Join Us
              </Button>
