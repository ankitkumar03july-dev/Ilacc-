    ...
    <footer className="bg-foreground text-background">
      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          {/* About */}
          <div>
            <h3 className="font-heading text-base font-bold mb-4 uppercase tracking-wider">About ILACC</h3>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-heading text-base font-bold mb-4 uppercase tracking-wider">Quick Links</h3>
            <ul className="space-y-3">
          ...
          {/* Contact */}
          <div>
            <h3 className="font-heading text-base font-bold mb-4 uppercase tracking-wider">Contact</h3>
      ...
      <div className="border-t border-background/10">
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm opacity-70">
            <p>© {new Date().getFullYear()} ILACC – Indo-Latin American & Caribbean Council. All rights reserved.</p>
            <div className="flex gap-6">
              <a href="#privacy" className="hover:opacity-100 hover:text-primary transition-all">
                Privacy Policy
              </a>
              <a href="#terms" className="hover:opacity-100 hover:text-primary transition-all">
                Terms of Service
              </a>
            </div>
          </div>
